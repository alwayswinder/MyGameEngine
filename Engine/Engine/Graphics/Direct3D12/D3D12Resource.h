...
namespace primal::graphics::d3d12
{
	...
	struct descriptor_handle
	{
		...
		[[nodiscard]] constexpr bool is_shader_valid()const { return gpu.ptr != 0; }
#ifdef _DEBUG
	private:
	...
	public:
		...
		bool initialize(u32 capacity, bool is_shader_visiable);
	...
	public:
		...
		constexpr d3d12_render_texture(d3d12_render_texture&& o)
			:_texture{ std::move(o._texture) }, _mip_cout{ o._mip_cout }
		{
			for (u32 i{ 0 }; i < _mip_cout; ++i)	_rtv[i] = o._rtv[i];
			o.reset();
		}
		...
		void release();
		[[nodiscard]] constexpr u32 mip_count()const { return _mip_cout; }
		[[nodiscard]] constexpr D3D12_CPU_DESCRIPTOR_HANDLE rtv(u32 mip_index)const { assert(mip_index < _mip_cout); return _rtv[mip_index].cpu; }
	...
	private:
		constexpr void move(d3d12_render_texture &o)
		{
			...
			_mip_cout = o._mip_cout;
			for (u32 i{ 0 }; i < _mip_cout; ++i) _rtv[i] = o._rtv[i];
			o.reset();
		}
		constexpr void reset()
		{
			for (u32 i{ 0 }; i < _mip_cout; ++i) _rtv[i] = {};
			_mip_cout = 0;
		}
