    ...
    class Geometry : Asset
    {
        ...
        public override IEnumerable<string> Save(string file)
        {
            ...
            try
            {
                foreach(var lodGroup in _lodGroups)
                {
                    ...
                    using (var writer = new BinaryWriter(new MemoryStream()))
                    {
                        ...
                        Icon = GemerateIcon(lodGroup.LODs[0]);
                    }
            ...
            catch(Exception ex)
            {
                ...
                Logger.Log(MessageType.Error, $"Failed to save geomotry to {file}");
            }

            return savedFiles;
        }

        private byte[] GemerateIcon(MeshLOD lod)
        {
            var width = 90 * 4;
